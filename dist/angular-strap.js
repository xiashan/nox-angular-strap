...
(function(window, document, undefined) {
  ...
  angular.module('mgcrea.ngStrap', [ 'mgcrea.ngStrap.modal', 'mgcrea.ngStrap.alert', 'mgcrea.ngStrap.select', 'mgcrea.ngStrap.datepicker', 'mgcrea.ngStrap.rangedatepicker', 'mgcrea.ngStrap.timepicker', 'mgcrea.ngStrap.tooltip', 'mgcrea.ngStrap.popover', 'mgcrea.ngStrap.dropdown', 'mgcrea.ngStrap.tab', 'mgcrea.ngStrap.pagination', 'mgcrea.ngStrap.sort' ]);
})(window, document);